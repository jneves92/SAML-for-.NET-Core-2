...
namespace ExampleWebApi.Controllers
{
    ...
    public class SamlController : Controller
    {
        ...
        public async Task<IActionResult> AssertionConsumerService()
        {
            ...
            Response.Headers.Add(_configuration["JWT:CookieName"], jwt);
        ...
        private JwtSecurityToken CreateJwtSecurityToken(ISpSsoResult ssoResult)
        {
            ...
            if (ssoResult.Attributes != null)
            {
                ...
                samlAttribute = ssoResult.Attributes.SingleOrDefault(a => a.Name == "GivenName");
                ...
                samlAttribute = ssoResult.Attributes.SingleOrDefault(a => a.Name == "Surname");
